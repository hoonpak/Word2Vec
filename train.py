...
if file_num == 0:
    root_path = "/home/user19/bag/1-billion-word-language-modeling-benchmark-r13output/training-monolingual.tokenized.shuffled"
    path_list = [root_path + "/" + path for path in os.listdir(root_path)]
    root_path = "/home/user19/bag/Word2Vec/news_data"
    path_list += [root_path + "/" + path for path in os.listdir(root_path)]
